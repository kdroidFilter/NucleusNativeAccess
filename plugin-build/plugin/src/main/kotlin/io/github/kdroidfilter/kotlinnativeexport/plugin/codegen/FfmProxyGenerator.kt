...
class FfmProxyGenerator {
    ...
    fun generate(module: KneModule, jvmPackage: String): Map<String, String> {
        ...
        files["KneRuntime.kt"] = generateRuntime(module.libName, jvmPackage, callbackSignatures, moduleSuspend)
    ...
    private fun generateRuntime(libName: String, pkg: String, callbackSignatures: Set<KneType.FUNCTION> = emptySet(), hasSuspend: Boolean = false): String = buildString {
